...
impl session::Trait for Runtime {
	...
	type ValidatorIdOf = ostaking::StashOf<Self>;
	type SelectInitialValidators = Staking;
	type DisabledValidatorsThreshold = DisabledValidatorsThreshold;
}

impl session::historical::Trait for Runtime {
	type FullIdentification = ostaking::Exposure<AccountId, Balance>;
	type FullIdentificationOf = ostaking::ExposureOf<Runtime>;
}
...
parameter_types! {
	...
	pub const BondingDuration: ostaking::EraIndex = 24 * 28;
	pub const RewardCurve: &'static PiecewiseLinear<'static> = &REWARD_CURVE;
}

impl ostaking::Trait for Runtime {
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Kton: kton,
		Staking: ostaking::{default, OfflineWorker},
